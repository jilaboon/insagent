    ...
    >
      ...
      <div className="border-t border-surface-100 pt-3">
        <MessageComposer
          ...
          existingMessage={
            hasMessage && (insight as unknown as Record<string, unknown>).messageBody
              ? {
                  id: ((insight as unknown as Record<string, unknown>).messageId as string) || insight.id,
                  customerId: insight.customerId,
                  customerName: insight.customerName,
                  insightId: insight.id,
                  insightTitle: insight.title,
                  body: (insight as unknown as Record<string, unknown>).messageBody as string,
                  tone: null,
                  purpose: null,
